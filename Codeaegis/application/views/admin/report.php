      ...
      <div class="main-content">
        ...
        <div class="page-content">
		  ...
		  if(isset($_POST['submit'])){
			  echo base_url()/report/index;
		  }
          $attributes = array("class" => "form-horizontal", "id" => "report", "name" => "report",'onsubmit' => "index()");
                ...
                <div class="panel-content">
                  <table class="table table-hover table-dynamic filter-head">
					...
					<?php for ($i = 0; $i < count($deptlist); ++$i) { ?>
                      <tr>
                        <td><?php echo $deptlist[$i]->userid?></td>
                        <td><?php echo $deptlist[$i]->tdate?></td>
                        <td><?php echo $deptlist[$i]->itime?></td>
                        <td><?php echo $deptlist[$i]->distance_from_mapped_qr?></td>
                        <td>X</td>
                      </tr>
                    <?php }?>  
                    </tbody>
