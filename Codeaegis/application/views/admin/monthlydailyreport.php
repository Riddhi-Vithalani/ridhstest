           ...
           <div class="row">
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input class="form-control form-white" type="date" id="tdate"  value="<?php //echo"$var"?>">
                              </div>
                            </div>
			 ...
			 <?php  foreach($fieldofficer as $row)
            { ?>
			...
			<?php } ?>
						  ...
						  <div class="col-md-2"> 
                          <button type="submit" name="submit" id="sup1" value="Show" onclick="disp();" class="btn btn-embossed btn-primary m-r-20">Search</button>
						  <button type="submit" name="submit" id="btnExport"  class="btn btn-embossed btn-primary m-r-20">Downoad</button>
						  </div>
                        </div>
          </div>
		    <div class="row">
